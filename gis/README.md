...
Sample geographic data files with world landmark locations.

| File | Format | Description |
|------|--------|-------------|
| sample.geojson | GeoJSON | Points (Eiffel Tower, Statue of Liberty) and polygon |
| sample.kml | KML | Keyhole Markup Language with placemarks |
